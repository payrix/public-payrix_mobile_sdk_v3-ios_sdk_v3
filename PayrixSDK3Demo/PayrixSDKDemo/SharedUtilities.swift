...
class SharedUtilities: NSObject
{
	...
	//Txn Session Key
	let txnSessionKeyDefaultsKey = "TransactionSessionKey"
	let txnSessionIDDefaultsKey = "TransactionSessionIDKey"
	...
	public func setTxnSessionKey(key: String)
	{
		userDefaults.set(key, forKey: txnSessionKeyDefaultsKey)
	}
	
	public func getTxnSessionKey() -> String?
	{
		let foundValue = userDefaults.string(forKey: txnSessionKeyDefaultsKey)
		return foundValue
	}
	
	public func setTxnSessionID(key: String)
	{
		userDefaults.set(key, forKey: txnSessionIDDefaultsKey)
	}
	
	public func getTxnSessionID() -> String?
	{
		let foundValue = userDefaults.string(forKey: txnSessionIDDefaultsKey)
		return foundValue
	}
